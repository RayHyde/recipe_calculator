$(document).ready(function () {
	...
	function appendInputs() {
		ing.find('ul').append('<li><div class="row"><div class="col-xs-2"><input type="text" placeholder="hoev." id="qty-'+i+'" class="qty" name="qty" value="'+ qtys[i] +'"></div><div class="col-xs-2"><input type="text" placeholder="bijv. gr" id="type-'+i+'" class="type" name="type" value="'+types[i]+'"></div><div class="col-xs-7"><input type="text" placeholder="bijv. bloem" id="desc-'+i+'" class="desc" name="desc" value="'+descs[i]+'"></div><div class="col-xs-1"><button title="Dit ingrediënt verwijderen" alt="Dit ingrediënt verwijderen" class="btn btn-default btn-sm del"><span class="glyphicon glyphicon-remove"></span></button></div></div></li>');
	}
	...
	function crunchAll() {
		...
		$('#crunched .print-header h3').text('Hoeveelheid: ' + $('#newQty').val() + ' ' + $('#orgType').val());
